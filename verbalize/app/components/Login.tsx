                ...
                <div className="bg-white w-full max-w-md rounded-[40px] shadow-sm p-12 flex flex-col">
                    ...
                    <div className ="flex items-center flex-col">
                        ...
                        <h1 className="text-3xl font-bold mb-10 text-black">Sign in</h1>
                            ...
                            <button type="submit" className="w-full active:scale-95 bg-[#4A86A8] hover:bg-[#3d6e8a] text-white font-bold py-4 rounded-xl transition-colors shadow-lg shadow-[#4A86A8]/30">
                                Verbalize →
                            </button>
