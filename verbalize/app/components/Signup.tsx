                ...
                <div className="bg-white w-full max-w-md rounded-[40px] shadow-sm px-12 py-3 flex flex-col">
                    ...
                    <div className="w-full space-y-4">
                        <div className="flex flex-row gap-2">
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="name" value={name} onChange={(e) => setName(e.target.value)} className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A86A8]/20 text-black"></input>
                                </div>
                            </div>
                            <div>
                                ...
                                <div className="relative">
                                    ...
                                    <input type="lastname" value={lastname} onChange={(e) => setLastname(e.target.value)} className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A86A8]/20 text-black"></input>
                                </div>
                            </div>
                        </div>
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input type="email" value={email} onChange={(e) => setEmail(e.target.value)} className="w-full pl-12 pr-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#4A86A8]/20 text-black"></input>
                            </div>
                        </div>
                        <div>
                        ...
                        <div>
                                ...
                                <div className="relative">
                                    <span className="absolute left-4 top-3 text-gray-400 opacity-20">🔒︎</span>
                                    <input type="password" value={confirmPassword} onChange={(e) => setConfirmPassword(e.target.value)} className={`w-full border ${error ? 'border-red-500' : 'border-gray-300'} rounded-xl py-3 pl-10 pr-4 outline-none focus:ring-2 focus:ring-[#4A86A8]/20 text-black`} />
                                    {error && (
                    ...
                    <div>
                        <button onClick={checkPassword} className=" active:scale-95 w-full bg-[#4A86A8] hover:bg-[#3d6e8a] text-white font-bold py-4 rounded-xl transition-colors shadow-lg shadow-[#4A86A8]/30 mt-6">
                            Create Account
                        </button>
                    </div>
